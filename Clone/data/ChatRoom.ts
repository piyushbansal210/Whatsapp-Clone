export default [{
    ...
    users: [{
      ...
      id: 'u2',
      name: 'Faiz Hasan',
      imageUri: 'https://source.unsplash.com/800x800/?nature,water',
    }],
    lastMessage: {
      id: 'm1',
      content: 'bas bhai badia',
    ...
    users: [{
      ...
      id: 'u3',
      name: 'Daniil',
      imageUri: 'https://source.unsplash.com/700x700/?nature',
    }],
    lastMessage: {
      id: 'm2',
    ...
    users: [{
      ...
      id: 'u4',
      name: 'Alex',
      imageUri: 'https://source.unsplash.com/700x700/?alex',
    }],
    lastMessage: {
      id: 'm3',
      content: 'Hi, Vadim.',
    ...
    users: [{
      ...
      id: 'u5',
      name: 'Vlad',
      imageUri: 'https://source.unsplash.com/700x700/?vlad',
    }],
    lastMessage: {
      id: 'm4',
    ...
    users: [{
      ...
      id: 'u6',
      name: 'Elon Musk',
      imageUri: 'https://source.unsplash.com/700x700/?elon',
    }],
    lastMessage: {
      id: 'm5',
    ...
    users: [{
      ...
      id: 'u7',
      name: 'Adrian',
      imageUri: 'https://source.unsplash.com/700x700/?adrian',
    }],
    lastMessage: {
      id: 'm6',
    ...
    users: [{
      ...
      id: 'u8',
      name: 'Borja',
      imageUri: 'https://source.unsplash.com/700x700/?borja',
    }],
    lastMessage: {
      id: 'm7',
      content: 'How are you doing?',
