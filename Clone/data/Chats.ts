...
export default {
	...
	messages: [{
		...
		id: 'm2',
		content: 'Mai ek dum maast chal rha',
		...
		id: 'm4',
		content: 'Mai bhi ek dum rapchick, lagge pade bhai ghar par toh',
		...
		id: 'm5',
		content: 'Teri padhai kaise chal rahi',
		...
		id: 'm6',
		content: 'jaise tere ghar par lage pade same, teri kaise chal rahi ',
		createdAt: '2020-10-03T14:49:00.000Z',
		user: {
			id: 'u2',
			name: 'Faiz Hasan',
